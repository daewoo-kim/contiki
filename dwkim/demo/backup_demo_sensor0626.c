...
PROCESS_THREAD(demo_source, ev, data) {
	...
	uint8_t data_sensing[UART_Full]={0,};
	data_sensing[0]=10;data_sensing[UART_Full-1]=99;
	...
	while (1) {
		...
		printf("%d\t%d\n",data_sensing[0],data_sensing[UART_Full-1]);
		/* RAIDO_LISTEN :
...
//				//UART_NumInput=0; 	//이 역할은 slip에서 하는게 맞을 듯
//			}
		}
